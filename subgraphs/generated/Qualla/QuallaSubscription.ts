...
export class QuallaSubscription extends ethereum.SmartContract {
  static bind(address: Address): QuallaSubscription {
    return new QuallaSubscription("QuallaSubscription", address);
  }
